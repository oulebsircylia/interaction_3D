...
#define convertx(x) ((x)*(Y*2)/WID - Y)
#define converty(y) ((y)*(X*2)/HEI - X)
...
t=clock()-t;
cout<< "telpo:"<<t <<"ms"<< endl;

//***********
cout<< " le temps d'execution est de : "<<t<<" ms"<< " avec "<<NB_THREAD<<" threads "<< endl;
